 ...
 * @author abysmli
 */
public class Valve113 extends SimulationComponent {
    ...
    public Valve113(int x, int y, int width, int height, double pipeWidthPorcentage, int widthPipe, String name) {

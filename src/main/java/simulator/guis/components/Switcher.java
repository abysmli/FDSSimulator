 ...
 * @author abysmli
 */
public class Switcher extends SimulationComponent {
    
    private static final long serialVersionUID = 1L;
    private boolean state;

    public Switcher(int x, int y, int width, int height, double pipeWidthPorcentage) {
    ...
    public void setSwitcherState(int state) {
        this.state = (state == 1);
        repaint();
    }
}

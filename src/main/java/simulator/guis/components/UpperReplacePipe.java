 ...
 * @author abysmli
 */
public class UpperReplacePipe extends SimulationComponent {
    ...
    public UpperReplacePipe(Tank102 upperTank, Tank101 lowerTank, Valve valve) {
        super(upperTank.getOutputX() - upperTank.getPipeRadius() - 30, 
                upperTank.getOutputY(),
                lowerTank.getInputX() - (upperTank.getOutputX() - upperTank.getPipeRadius()) + 30,
                (lowerTank.getInputY() + lowerTank.getPipeRadius()) - upperTank.getOutputY() + 100,

...
public class AirValve extends SimulationComponent
{
	...
	public AirValve(int x, int y, int width, int height, double pipeWidthPorcentage, int widthPipe, String name) 
	{

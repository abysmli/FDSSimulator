...
public class ManualValveLower extends SimulationComponent {
    ...
    public ManualValveLower(int x, int y, int width, int height, double pipeWidthPorcentage, int widthPipe, String name) {
